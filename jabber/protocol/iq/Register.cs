...
namespace jabber.protocol.iq
{
	...
	public class RegisterIQ : jabber.protocol.client.TypedIQ<Register>
	{
		...
		public RegisterIQ(XmlDocument doc)
			: base(doc)
		{
		}
	}
	...
	public class Register : Element
	{
		...
		{
			XmlNodeList nl = GetElementsByTagName("data", URI.BOBDATA);
			BobData[] bobData = new BobData[nl.Count];
			int i = 0;
			foreach (BobData n in nl)
				bobData[i++] = n;
			return bobData;
		}
	}

	//[System.Xml.Serialization.XmlElement(ElementName = "Data", Namespace = URI.BOBDATA)]
	public class BobData : Element
	{
		public BobData(XmlDocument doc)
			: base("data", URI.BOBDATA, doc)
		{
		}

		public BobData(string prefix, XmlQualifiedName qname, XmlDocument doc)
			: base(prefix, qname, doc)
		{
		}
		...
		public string CID
		{
			get { return GetAttribute("cid"); }
			set { SetAttribute("cid", value); }
		}

		// TODO: MaxAge property
