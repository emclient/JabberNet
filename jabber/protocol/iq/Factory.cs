...
namespace jabber.protocol.iq
{
    ...
    public class Factory : IPacketTypes
    {
        private static QnameType[] s_qnt = new QnameType[]
        {
			...
			new QnameType("open", URI.IBB,      typeof(jabber.protocol.iq.OpenIBB)),
			new QnameType("close", URI.IBB,      typeof(jabber.protocol.iq.CloseIBB)),
			new QnameType("data", URI.IBB,      typeof(jabber.protocol.iq.IBBData)),
