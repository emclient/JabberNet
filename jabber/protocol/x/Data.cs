...
namespace jabber.protocol.x
{
	...
	public class Data : Element
	{
		...
		public Data(XmlDocument doc)
			: base("x", URI.XDATA, doc)
		{
		}
	...
	public class Field : Element
	{
		...
		/// </summary>
		/// <param name="doc"></param>
		public Field(XmlDocument doc)
			: base("field", URI.XDATA, doc)
		{
		}
		...
		{
			XmlNodeList nl = GetElementsByTagName("media", URI.MEDIA);
			Media[] media = new Media[nl.Count];
			int i = 0;
			foreach (Media n in nl)
				media[i++] = n;
			return media;
		}
	}
	...
	public class Option : Element
	{
		...
		/// </summary>
		/// <param name="doc"></param>
		public Option(XmlDocument doc)
			: base("option", URI.XDATA, doc)
		{
		}
	...
	{
		public Media(XmlDocument doc)
			: base("media", URI.MEDIA, doc)
		{
		}

		public Media(string prefix, XmlQualifiedName qname, XmlDocument doc)
			: base(prefix, qname, doc)
		{
		}
		...
		public MediaURI[] GetURIs()
		{
			XmlNodeList nl = GetElementsByTagName("uri", URI.MEDIA);
			MediaURI[] mediaURIs = new MediaURI[nl.Count];
			int i = 0;
			foreach (MediaURI n in nl)
				mediaURIs[i++] = n;
			return mediaURIs;
		}
	}

	public class MediaURI : Element
	{
		public MediaURI(XmlDocument doc)
			: base("uri", URI.MEDIA, doc)
		{
		}

		public MediaURI(string prefix, XmlQualifiedName qname, XmlDocument doc)
			: base(prefix, qname, doc)
		{
		}
